...
const log_in = async () => {
    ...
    if (res.data.user) await navigateTo('/customers')
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="log_in">
                        <div>
                            <label for="email" class="block mb-2 text-lg font-semibold text-gray-900 dark:text-white">Your
                                email</label>
                        ...
                        <div>
                            <label for="password"
                                class="block mb-2 text-lg font-semibold text-gray-900 dark:text-white">Password</label>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don’t have an account yet? <span @click="sign_up"
